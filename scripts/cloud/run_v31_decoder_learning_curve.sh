...
export PROJECT_ROOT STORAGE_ROOT PYTHON PUBLICATION_ROOT V30_ROOT SOURCE_ROOT OUTPUT LOG_ROOT BARRIER PYTHONPATH CUDA_VISIBLE_DEVICES PYTHONUNBUFFERED
...
"$PYTHON" scripts/seal_v31_learning_curve.py --output "$OUTPUT" --barrier "$BARRIER" \
